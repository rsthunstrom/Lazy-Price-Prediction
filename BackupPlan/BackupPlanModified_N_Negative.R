...
for(i in 1:nrow(sorted_data_short)) {
  ...
  norm_file_size_data[(i: nrow(sorted_data_short)), id_col]<- sorted_data_short$N_Negative[i]
...
saveRDS(norm_file_size_data, file = "n_negative.rds")
# Restore the object
...
write.csv(yoy_file_size, file = "N_negative.csv")

str(yoy_file_size)
#### saving some data
# Save an object to a file
saveRDS(yoy_file_size, file = "N_negative.rds")
# Restore the object
...
#### saving some data
# Save an object to a file
saveRDS(port_last_day, file = "n_uncertain.rds")
# Restore the object
...
write.csv(combined_dataframe, file = "combined_DF_files_N_negative.csv")
saveRDS(combined_dataframe, file = "n_negative.rds")
# Restore the object
#readRDS(file = "my_data.rds")

##### recovering data

combined_dataframe<- read.csv(file = "combined_DF_files_N_negative.csv")
...
sink("summaryQ1_N_negative2.txt")
summary(linear_model_Q1)
sink()
...
sink("summaryQ5_N_negative2.txt")
summary(linear_model_Q5)
sink()
...
sink("summaryQ5Q1_N_negative.txt")
summary(linear_model_Q5Q1)
sink()
...
sink("summaryQ5Q1_N_positive2.txt")
summary(linear_model_Q5Q1)
sink()

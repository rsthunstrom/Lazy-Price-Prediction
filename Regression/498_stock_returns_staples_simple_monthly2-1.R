...
quintiles_data <- read.csv("Stuart2transposedSimple.csv", header = TRUE, sep="\t")
...
write.csv(combined_dataframe, file = "combined_DF_simple3.csv")

combined_dataframe<- read.csv(file = "combined_DF_simple3.csv")
...
t.test(combined_dataframe$Q1Q5_adj_return_2, combined_dataframe$RF, paired=TRUE) 

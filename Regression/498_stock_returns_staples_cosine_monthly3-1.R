...
quintiles_data <- read.csv("Stuart2transposedCosine.csv", header = TRUE)
...
combined_dataframe$Q5Q1_adj_return_2 <- (100*combined_dataframe$Q5_return - 100*combined_dataframe$Q1_return) -combined_dataframe$RF
combined_dataframe$Q5Q1_adj_return_3 <- (combined_dataframe$Q5_return - combined_dataframe$Q1_return) 
...
mean(combined_dataframe$Q5Q1_adj_return)
mean(combined_dataframe$Q5Q1_adj_return_2)
#### write completed DF into a CSV file
write.csv(combined_dataframe, file = "combined_DF_cosine4.csv")

##### recovering data
combined_dataframe<- read.csv(file = "combined_DF_cosine4.csv")
...
t.test(combined_dataframe$Q5Q1_adj_return_3, combined_dataframe$RF, paired=TRUE) 
